package com.ervalsa.mystackwidget
...
class ImageBannerWidget : AppWidgetProvider() {
    ...
    companion object {
        private const val TOAST_ACTION = "com.ervalsa.mystackwidget.TOAST_ACTION"
        const val EXTRA_ITEM = "com.ervalsa.mystackwidget.EXTRA_ITEM"
